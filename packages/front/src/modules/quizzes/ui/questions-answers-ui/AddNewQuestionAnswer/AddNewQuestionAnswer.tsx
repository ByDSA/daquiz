...
import { useCreateOneQuestionTextAnswerAndGet } from "#modules/questions-answers";
import { QuestionChoice } from "#modules/questions";
import { AnswerType } from "#modules/answers";
...
function getChoices(formData: FormData, answerText: string): QuestionChoice[] | null {
